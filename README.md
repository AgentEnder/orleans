<p align="center">
  <image src="assets/logo_full.png" alt="Orleans logo" width="600px">
</p>
...
Please see the [Orleans Hello World quickstart](https://dotnet.github.io/orleans/docs/tutorials-and-samples/hello-world/).
